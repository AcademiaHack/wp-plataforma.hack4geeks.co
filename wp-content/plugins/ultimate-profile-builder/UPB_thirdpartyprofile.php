...
<div class="top-part">
		...
		<div class="profile-user-name">
			...
			<?php the_author_meta('first_name',$current_id); ?>&nbsp;<?php the_author_meta('last_name',$current_id); ?>
        ...
        <div class="main-edit-profile" >
			...
			<div class="left-img-part">
                ...
                <?php if($avtar_image[0]!='') :?>
                 ...
                 <img src="<?php echo $path . 'images/default.jpg'; ?>" />
            ...
            <div class="right-profile-info">
                ...
                <div class="user-web-info"> Website: <a href="<?php the_author_meta('user_url',$current_id); ?>"><?php the_author_meta('user_url',$current_id); ?></a></div>
