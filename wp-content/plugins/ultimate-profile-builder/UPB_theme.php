...
.UltimatePB-Button,#upb-form input[type="submit"],#upb-form input[type="reset"] {
	...
	<?php if($front_theme!='lightmoderngreen' && $front_theme!='lightmodernyellow'): ?>



	border-top: 1px solid <?php echo $button_colorDark; ?>;

	background: -webkit-gradient(linear, left top, left bottom, from(<?php echo $button_colorDark; ?>), to(<?php echo $button_colorLight; ?>));



	background: -webkit-linear-gradient(top, <?php echo $button_colorDark; ?>, <?php echo $button_colorLight; ?>);



	background: -moz-linear-gradient(top, <?php echo $button_colorDark; ?>, <?php echo $button_colorLight; ?>);



	background: -ms-linear-gradient(top, <?php echo $button_colorDark; ?>, <?php echo $button_colorLight; ?>);



	background: -o-linear-gradient(top, <?php echo $button_colorDark; ?>, <?php echo $button_colorLight; ?>);
